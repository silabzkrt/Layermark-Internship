...
public class DynamicDdlEngine {
    ...
    public void createTableIfNotExists(TableMetadata tableMetadata) {
        validateIdentifier(tableMetadata.getTableName());
    ...
    public void addColumn(String tableName, ColumnMetadata column) {
        ...
        validateIdentifier(column.getName());
    ...
    private void validateIdentifier(String identifier) {
        if (identifier == null || !IDENTIFIER_PATTERN.matcher(identifier).matches()) {
            throw new IllegalArgumentException("Invalid or unsafe SQL identifier: " + identifier);
        }
    }
}
